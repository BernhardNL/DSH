...
export class DataService extends Service {
    ...
    async process(agent, root, fileName, displaySpec, signal) {
        ...
        if (displaySpec && displaySpec.trim()) {
            const code = await completeText(this.ctx, agent, [
            ...
            ].join('\n'), `Request: ${displaySpec}\nFile: ${fileName}`, { temperature: 0.2, maxTokens: 1200 }, signal);
